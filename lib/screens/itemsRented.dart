...
class ItemsRented extends StatefulWidget {
  @override
  _ItemsRentedState createState() => _ItemsRentedState();
}

class _ItemsRentedState extends State<ItemsRented> {
          ...
          Column(
            children: [
              ...
              Padding(
                ...
                child: Text("Items you have borrowed:",
